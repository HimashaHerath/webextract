...
class WebScraper:
        ...
        for attempt in range(settings.RETRY_ATTEMPTS):
            try:
                ...
                try:
                    ...
                    page.wait_for_function("document.body && document.body.innerText.length > 100", timeout=5000)
                except:
                    # Fallback wait
    ...
    def _remove_unwanted_elements(self, soup: BeautifulSoup):
        ...
        unwanted_selectors = [
            ...
            '.popup', '.modal', '.cookie-notice', '.banner',
            '#nav', '#navigation', '#header', '#footer',
            '#menu', '#sidebar', '#advertisement', '#ads',
    ...
    def _extract_text_from_element(self, element: Tag) -> str:
        ...
        for elem in element_copy.descendants:
            ...
            elif elem.name in ['p', 'div', 'section', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'li', 'br']:
                text_parts.append('\n')
    ...
    def _fallback_content_extraction(self, soup: BeautifulSoup) -> str:
        ...
        text_elements = body.find_all(['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'li', 'td', 'blockquote'])
    ...
    def _is_important_link(self, url: str, link_element: Tag) -> bool:
        ...
        skip_patterns = [
            ...
            '/logout', '/signout', '/password', '/forgot',
