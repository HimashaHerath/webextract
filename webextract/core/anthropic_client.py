            ...
            for attempt in range(3):  # Claude is reliable, fewer retries needed
                try:
                    ...
                    response = self._client.messages.create(
                        ...
                        max_tokens=2000,
                        temperature=0.1,
                        system="You are an expert content analyzer. Extract structured information from the provided content and return it as valid JSON. Follow the instructions exactly and return only the JSON object.",
                    ...
                    if "rate" in error_str and "limit" in error_str:
                        ...
                        raise ModelNotAvailableError(f"Anthropic model {self.model_name} not available: {e}")
